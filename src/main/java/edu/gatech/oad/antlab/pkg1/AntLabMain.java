 ...
 public class AntLabMain {
    ...
    public void printOutMessage() {
        ...
        String toPrint = 
		  ...
		  Person1 p1 = new Person1("Adam Cooke");
		  toPrint += p1.toString("acooke6");
		  //Person2 replace P2 with your name
		  //and gburdell with your gt id
		  Person2 p2 = new Person2("Margaret O'Hara");
		  toPrint += p2.toString("mohara3");
		  //Person3 replace P3 with your name
		  //and gburdell3 with your gt id
		  Person3 p3 = new Person3("Julia Rapoport");
		  toPrint += p3.toString("jrapoport6");
                  //Person4 replace P4 with your name
                  //and gburdell4 with your gt id
                  Person4 p4 = new Person4("Ting Zhang");
                  toPrint += p4.toString("tzhang85");
                  //Person5 replace P4 with your name
                  //and gburdell5 with your gt id
                  Person5 p5 = new Person5("Chris Tansey");
                  toPrint += p5.toString("ctansey3");
